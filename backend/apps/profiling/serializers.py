...
class ProfileColumnSerializer(serializers.Serializer):
    ...
    variance = serializers.JSONField(required=False, allow_null=True)
    coefficient_of_variation = serializers.JSONField(required=False, allow_null=True)
    skewness = serializers.JSONField(required=False, allow_null=True)
    kurtosis = serializers.JSONField(required=False, allow_null=True)
    percentile_5 = serializers.JSONField(required=False, allow_null=True)
    percentile_95 = serializers.JSONField(required=False, allow_null=True)
    outlier_count = serializers.IntegerField(required=False, allow_null=True)
    outlier_percentage = serializers.FloatField(required=False, allow_null=True)
